...
| Audience | Doc |
|---|---|
| Everyone | [Product overview](./product/overview.md) |
| New contributors | [Getting started](./getting-started.md) |
| Agents / Cursor | [AGENTS.md](../AGENTS.md) · [Skills](./agents/skills.md) |
| Architects | [Architecture](./architecture/overview.md) |
| API consumers | [API reference](./api/overview.md) |
| Operators | [Ops index](./ops/overview.md) |
...
- [Tenancy & routing](./architecture/tenancy.md)
...
- [ADR-006: Indexable category facet URLs](./architecture/adr/006-indexable-facet-urls.md)
- [ADR-007: Province hosts + 38/514 geography](./architecture/adr/007-province-hosts.md)
...
- [bali.business migration](./migration-bali.md)
- [Mercur integration](./mercur-integration.md)

### Agents

- [Cursor skills & rules](./agents/skills.md)
