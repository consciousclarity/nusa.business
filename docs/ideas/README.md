...
| Idea | Status | Updated |
|---|---|---|
| [Listing discovery: same address, similar, nearby map](./2026-09-08-listing-nearby-discovery.md) | `exploring` | 2026-09-08 |
| [Going deeper than place.island hosts](./2026-09-08-geo-deeper-than-host.md) | `exploring` | 2026-09-08 |
