...
| i18n en/id | partial | Public `/id` prefix + chrome copy including listing widgets, Indonesian category/facet labels, JSON-LD, localized form errors, and HTML 404/500; listing body stays author language |
