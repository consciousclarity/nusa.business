...
| 6 Packages & messaging | Feature gates, inbox | Planned |
| 7 bali.business cutover | Export + 301 | Planned |
| 8 Postgres + Meilisearch | Production data plane | Planned |
| 9 i18n | `en` / `id` routes | Partial |
| 10 Maps | MapLibre + PostGIS nearby | Planned |

Update [features-parity.md](../features-parity.md) when a row moves to **done**.
