...
| i18n en/id | partial | Public `/id` prefix + chrome copy including listing widgets, Indonesian category/facet labels, JSON-LD `additionalType`, and `/id` sitemap locs; listing body stays author language |
