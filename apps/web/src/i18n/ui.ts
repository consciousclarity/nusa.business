...
const ui = {
  en: {
    ...
    nationEyebrow: "Local connections · Indonesia",
    nationH1: "Find your next local favourite.",
    nationLede:
      "A place to eat. Someone who can help. Explore businesses across Indonesia and contact them directly when they share their details.",
    ...
    searchStart: "Start with a name, choose a province, or explore a category above.",
    noSearchMatches: "No listings matched. Try another province or a shorter name.",
    resultsIn: "listings",
    islands: "Provinces",
    provinces: "Provinces",
    province: "Province",
    regionHubs: "Island groups",
    regenciesCities: "Kabupaten & kota",
    places: "Places",
    ...
    similarNearby: "Similar businesses",
  ...
  id: {
    ...
    nationEyebrow: "Terhubung dengan bisnis lokal · Indonesia",
    nationH1: "Temukan bisnis lokal favorit Anda.",
    nationLede:
      "Tempat makan atau jasa yang Anda butuhkan. Jelajahi bisnis di seluruh Indonesia dan hubungi langsung jika detail kontak tersedia.",
    ...
    searchStart: "Mulai dengan nama bisnis, pilih provinsi, atau jelajahi kategori di atas.",
    noSearchMatches: "Tidak ada listing yang cocok. Coba provinsi lain atau nama yang lebih pendek.",
    resultsIn: "listing",
    islands: "Provinsi",
    provinces: "Provinsi",
    province: "Provinsi",
    regionHubs: "Kelompok pulau",
    regenciesCities: "Kabupaten & kota",
    places: "Tempat",
...
const regionNames: Record<Locale, Record<string, string>> = {
  en: {
    sumatra: "Sumatra",
    java: "Java",
    bali: "Bali",
...
export function regionName(locale: Locale, slug: string, fallback?: string): string {
  return regionNames[locale][slug] ?? regionNames.en[slug] ?? fallback ?? slug;
}

/** Public island/province name. Seed/API name stays English (canonical). */
